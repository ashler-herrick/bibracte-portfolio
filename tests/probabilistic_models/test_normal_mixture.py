# tests/test_deep_normal_mixture.py
...
def test_model_initialization(model):
    ...
    assert model.mean_linear.out_features == 3, "Incorrect number of mixture components in mean_linear."
    assert model.scale_linear.out_features == 3, "Incorrect number of mixture components in scale_linear."
...
def test_forward_pass(model):
    ...
    assert dist.component_distribution.mean.shape == (5, 3), "Incorrect shape for component means."
    assert dist.component_distribution.stddev.shape == (5, 3), "Incorrect shape for component stddev."
